...
const SidePanel = () => {
  return (
    <div  className='bg-slate-900 p-3 lg:p-5 rounded-lg border-white border'>
        <div className="flex items-center justify-between">
            <p className='text_para mt-0 font-semibold'>Ticket Price</p>
            <span className='text-[16px] leading-7 lg:text-[30px] lg:leading-8 text-headingColor font-bold'>Rs 500</span>
        </div>
