  ...
  return (
    <section>
      <div className="px-4 mx-auto max-w-screen-md">
        ...
        <p className='mb-8 lg:mb-16 font-light text-center text_para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam, reprehenderit.</p>
        <form action="#" className='space-y-8'>
            ...
            <div className='sm:col-span-2'>
              ...
              <textarea id="message" rows="6" placeholder='Leave a comment...' className='form_input mt-1'></textarea>
            </div>
